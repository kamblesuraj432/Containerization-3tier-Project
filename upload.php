...
'credentials' => [
'key'    => 'AKIA5KW7RU22NIATMZU4',     //Add your access key here
'secret' => 'sZQyf/0iW99D3IcJJFCITCKFUfjvmognIh4fu8pp'  //Add your secret key here
]
]);
...
$bucket = 'mysuraj';                        //Add your bucket name here
...
$password = "Suraj@123";  // Enter your database password here
$dbname = "user";      // Enter your database name here
...
$sql = "INSERT INTO hello(name,url) VALUES('$name','$s3url')";
